...
export interface _SERVICE {
  ...
  'setUserLevel' : ActorMethod<[string, bigint], undefined>,
  ...
  'updateUserPassword' : ActorMethod<[string, string], undefined>,
  'updateUserQuestion' : ActorMethod<[string, string], undefined>,
