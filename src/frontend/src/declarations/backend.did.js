...
export const idlService = IDL.Service({
  ...
  'setUserLevel' : IDL.Func([IDL.Text, IDL.Nat], [], []),
  ...
  'updateUserPassword' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'updateUserQuestion' : IDL.Func([IDL.Text, IDL.Text], [], []),
